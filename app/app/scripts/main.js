...
function setText(temp, condition, city) {
    ...
    switch (condition) {
        ...
        case 'flurries':
            if (temp < siberia) {
                conditionsMessageArray = [
                    "It's windy, <em>snowing</em> and cold as fuck"
                ];

                conditionsDescArray = [
                    "My face has frozen",
                    "It's the setting for the Thing"
                ...
                conditionsMessageArray = [
                    "It's freezing and there's <em>flurries</em>"
                ];
                ...
                conditionsMessageArray = [
                    "<em>flurries</em> at this time of the year?"
                ];
        ...
        case 'fog':
            ...
            if (temp < siberia) {
                conditionsMessageArray = [
                    "It's <em>foggy</em> and fucking FREEZING!"
                ];
                ...
                conditionsMessageArray = [
                    "It's <em>foggy</em> and freezing!"
                ];

                conditionsDescArray = [
                    "Breathing hurts",
                    "Just go back to bed",
                    "How did oyu get into this mess?"
                ];
                ...
                conditionsMessageArray = [
                    "It's <em>foggy</em> and a bit cold"
                ];
        ...
        case 'rain':
            ...
            if (temp < siberia) {
                conditionsMessageArray = [
                    "It's <em>raining</em> and fucking FREEZING!"
                ];
                ...
                conditionsMessageArray = [
                    "It's <em>raining</em> and roasting"
                ];

                conditionsDescArray = [
                    "It's raining boiling water?"
                ];
